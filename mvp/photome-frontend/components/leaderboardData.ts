...
export type Person = {
  ...
  export const PEOPLE: Person[] = [
    ...
    { id: "1", name: "Alice", photos: 31, avatarUri: "https://i.pravatar.cc/120?img=12" },
    { id: "2", name: "Ben", photos: 18, avatarUri: "https://i.pravatar.cc/120?img=32" },
    { id: "3", name: "Chloe", photos: 55, avatarUri: "https://i.pravatar.cc/120?img=45" },
    { id: "4", name: "Daniel", photos: 9, avatarUri: "https://i.pravatar.cc/120?img=22" },
  ];
